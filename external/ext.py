'''
Copyright (C) 2022 Rohan Nahak - All Rights Reserved
...
def LoadScyllaBanner():
    print(W + BOLD + "\n    --------------+--------------      ")
    print(G + "            ___ /R[___              _ ")
    print(G + "           /|scaninfoga.in   |#___________// ")
    print(G + "         ( -+ |ROHAN|    ______-----+/ ")
    print(G + "          ==_________--'            \  ")
    print(G + "            ~_|___|__                  \n" + END)
    print(B + BOLD + "_____________________________________" + END)
    print(R + BOLD + "               [Scaninfoga]                  " + END)        
    print(W + "-==[ " + BOLD + "The Information Gathering Engine" + END)
    print(W + "-==[ " + BOLD + "Developed By: Rohan Nahak    " + END)                                                                                                                                                             
