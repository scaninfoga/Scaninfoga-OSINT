'''
Copyright (C) 2020 Rohan Nahak - All Rights Reserved
...
Scylla - The Information Gathering Engine
    Developed By: Rohan Nahak
    https://www.scaninfoga.in
'''

'''
                                    NOTICE
The developer of this program, Rohan Nahak, written the following code
